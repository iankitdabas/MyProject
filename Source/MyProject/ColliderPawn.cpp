...
AColliderPawn::AColliderPawn()
{
	...
	SpringArm->GetRelativeRotation() = FRotator(-45.f, 0.f, 0.f);
...
void AColliderPawn::Tick(float DeltaTime)
{
	...
	NewSpringArmRotation.Pitch = FMath::Clamp(NewSpringArmRotation.Pitch += CameraInput.Y, -80.f, -15.0f);
...
void AColliderPawn::MoveForward(float input)
{
...
void AColliderPawn::MoveRight(float input)
{
